...
namespace WebApiAndEFPracticeApplication.Helper_Code.OAuth2
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider 
    {
        ...
        /// </summary>  
        private MemberLoginDetailsManager memberLoginDetailsManager = new MemberLoginDetailsManager();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var userId = this.memberLoginDetailsManager.LoginMember(usernameVal, passwordVal);
